...
import { JobSearchBox } from 'sub-components';
          ...
          <Col lg={6} sm={12}>
            <div>
              <div className=" text-center text-md-start ">
                {/* heading */}
                <h1 className=" display-2 fw-bold  mb-3">Find your dream job that you love to do.</h1>
                {/* lead */}
                <p className="lead">The largest remote work community in the world. Sign up and post a job or create your developer profile.</p>
              </div>
              <div className="mt-8">
                {/* job search form */}
                {/* <JobSearchBox /> */}
